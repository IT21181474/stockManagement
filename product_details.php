...
<body>
    ...
    <br><br><br>
    <br>
    <h2>Avaliable Product Items</h2><br>
    <table>
        <thead>
            <tr>
                <th>Action</th>
    ...
    <!-- <a href="addnewstocks.php?id=<?= isset($product['ID']) ? $product['ID'] : ''; ?>">Add new stock</a> -->
    <a href="addnewstocks.php?id=<?= $product['ID']; ?>">Add new stock</a><br><br>
    <br>
    <h2>Cart</h2>
